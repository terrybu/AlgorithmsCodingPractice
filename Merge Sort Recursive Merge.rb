def mergeSortRecursive(array)
	...
	leftArray = mergeSortRecursive(array[0...middleIndex]) 
	rightArray = mergeSortRecursive(array[middleIndex..array.count-1])
	...
	mergeRecursive(leftArray, rightArray)
end

def mergeRecursive(array1, array2)
	if array1.empty?
		return array2
	elsif array2.empty?
		return array1
